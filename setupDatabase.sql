...
ALTER TABLE "player_inputs" ADD FOREIGN KEY ("player1") REFERENCES "user" ("id");

ALTER TABLE "player_inputs" ADD FOREIGN KEY ("player2") REFERENCES "user" ("id");
...
ALTER TABLE "gameplan" ADD FOREIGN KEY ("player1") REFERENCES "user" ("id");

ALTER TABLE "gameplan" ADD FOREIGN KEY ("player2") REFERENCES "user" ("id");
...
ALTER TABLE "user_stats" ADD FOREIGN KEY ("userid") REFERENCES "user" ("id");
